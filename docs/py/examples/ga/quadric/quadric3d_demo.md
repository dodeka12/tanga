# reconstruct a quadric from 9 points and rotate it
...
```bash
uv run python py/examples/ga/quadric/quadric3d_demo.py
```

## Source

[`ga/quadric/quadric3d_demo.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/quadric/quadric3d_demo.py)
