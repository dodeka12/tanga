# classify a noisy quadric within a tolerance
...
```bash
uv run python py/examples/ga/quadric/tolerant_classification.py
```

## Source

[`ga/quadric/tolerant_classification.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/quadric/tolerant_classification.py)
