# Integer GA with a single modulus (Path C)
...
[`ga/algebra/modulus_algebra_single.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/algebra/modulus_algebra_single.py)
