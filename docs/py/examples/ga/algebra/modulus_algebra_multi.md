# Integer GA with two different moduli (NTRU style)
...
[`ga/algebra/modulus_algebra_multi.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/algebra/modulus_algebra_multi.py)
