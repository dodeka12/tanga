...
**Keywords:** solver · inverse · general solve · residual
...
[`ga/numerics/solver_basics_02.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/numerics/solver_basics_02.py)
