...
```bash
uv run python py/examples/ga/geometry/n3_operators.py
```

## Source

[`ga/geometry/n3_operators.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/geometry/n3_operators.py)
