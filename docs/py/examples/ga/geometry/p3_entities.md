...
```bash
uv run python py/examples/ga/geometry/p3_entities.py
```

## Source

[`ga/geometry/p3_entities.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/geometry/p3_entities.py)
