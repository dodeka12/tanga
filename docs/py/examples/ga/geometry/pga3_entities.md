# Gunn/Dorst PGA 3D geometry with plane‑based representation
...
```bash
uv run python py/examples/ga/geometry/pga3_entities.py
```

## Source

[`ga/geometry/pga3_entities.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/geometry/pga3_entities.py)
