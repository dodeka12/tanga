# Bind a variable to a sub-expression (composition)
...
```bash
uv run python py/examples/ga/expression/bind_subexpression.py
```

## Source

[`ga/expression/bind_subexpression.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/expression/bind_subexpression.py)
