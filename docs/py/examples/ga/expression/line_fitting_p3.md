# Least-squares line fitting in P3 with visualization
...
[`ga/expression/line_fitting_p3.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/expression/line_fitting_p3.py)
