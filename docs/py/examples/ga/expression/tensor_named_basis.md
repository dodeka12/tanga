# get_tensor() (raw MVTensor) + get_array() (named bases)
...
[`ga/expression/tensor_named_basis.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/expression/tensor_named_basis.py)
