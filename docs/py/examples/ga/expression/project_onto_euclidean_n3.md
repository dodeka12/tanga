# Project an N3 expression onto the Euclidean basis
...
[`ga/expression/project_onto_euclidean_n3.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/expression/project_onto_euclidean_n3.py)
