# Apply a fixed rotor to points with a Variable-backed expression
...
[`ga/expression/variable_rotor.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/expression/variable_rotor.py)
