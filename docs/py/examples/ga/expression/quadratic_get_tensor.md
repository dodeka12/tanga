# multilinear AffineExpression.get_tensor()
...
[`ga/expression/quadratic_get_tensor.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/expression/quadratic_get_tensor.py)
