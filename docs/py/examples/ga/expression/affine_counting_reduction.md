# Sum an AffineExpression over a batched variable
...
[`ga/expression/affine_counting_reduction.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/ga/expression/affine_counting_reduction.py)
