...
```bash
uv run python py/examples/viz/banners/scene_banner.py
```

## Source

[`viz/banners/scene_banner.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/banners/scene_banner.py)
