...
```bash
uv run python py/examples/viz/banners/banner_types.py
```

## Source

[`viz/banners/banner_types.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/banners/banner_types.py)
