# Auto-fit, explicit, and partial camera modes
...
```bash
uv run python py/examples/viz/camera/modes.py
```

## Source

[`viz/camera/modes.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/camera/modes.py)
