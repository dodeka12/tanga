# a live-updated camera view + pane swap
...
```bash
uv run python py/examples/viz/camera/pinhole_calibrated_streaming.py
```

## Source

[`viz/camera/pinhole_calibrated_streaming.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/camera/pinhole_calibrated_streaming.py)
