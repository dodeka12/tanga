# 3D projective camera via View3dConfig
...
```bash
uv run python py/examples/viz/camera/3d_plane.py
```

## Source

[`viz/camera/3d_plane.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/camera/3d_plane.py)
