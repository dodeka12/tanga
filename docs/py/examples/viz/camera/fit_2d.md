# 2D fit-camera keeps the axes/grid undistorted
...
```bash
uv run python py/examples/viz/camera/fit_2d.py
```

## Source

[`viz/camera/fit_2d.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/camera/fit_2d.py)
