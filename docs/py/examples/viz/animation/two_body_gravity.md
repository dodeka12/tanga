...
```bash
uv run python py/examples/viz/animation/two_body_gravity.py
```

## Source

[`viz/animation/two_body_gravity.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/animation/two_body_gravity.py)
