# Moving point with a color-gradient trail
...
[`viz/animation/point_path_trail.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/animation/point_path_trail.py)
...
"""point_path_trail.py — Moving point with a color-gradient trail.
