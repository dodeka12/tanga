...
```bash
uv run python py/examples/viz/animation/double_pendulum.py
```

## Source

[`viz/animation/double_pendulum.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/animation/double_pendulum.py)
