# Frame-by-frame animation at ~60 FPS
...
```bash
uv run python py/examples/viz/animation/orbit.py
```

## Source

[`viz/animation/orbit.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/animation/orbit.py)
