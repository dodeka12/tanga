# Keyframe timeline with fade-in and move
...
```bash
uv run python py/examples/viz/animation/timeline.py
```

## Source

[`viz/animation/timeline.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/animation/timeline.py)
