# Labels with custom styling, dynamic update, and removal
...
```bash
uv run python py/examples/viz/labels/basic.py
```

## Source

[`viz/labels/basic.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/labels/basic.py)
