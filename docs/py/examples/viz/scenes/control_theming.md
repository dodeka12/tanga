# Controls styled from the extracted theme CSS files

**Keywords:** scenes · controls · theme · css · button · slider · checkbox · icon_only
...
```bash
uv run python py/examples/viz/scenes/control_theming.py
```

## Source

[`viz/scenes/control_theming.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/control_theming.py)
...
Run with:  uv run python py/examples/viz/scenes/control_theming.py
