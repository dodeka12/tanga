...
```bash
uv run python py/examples/viz/scenes/control_group_single.py
```

## Source

[`viz/scenes/control_group_single.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/control_group_single.py)
...
Run with:  uv run python py/examples/viz/scenes/control_group_single.py
