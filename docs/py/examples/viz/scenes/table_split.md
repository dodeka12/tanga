...
**Keywords:** scenes · split view · table · tabular data · TableView
...
```bash
uv run python py/examples/viz/scenes/table_split.py
```

## Source

[`viz/scenes/table_split.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/table_split.py)
...
Run with:  uv run python py/examples/viz/scenes/table_split.py
