# A horizontal control toolbar nested inside a vertical stack
...
control pane is a vertical `~pytanga.viz.StackView` whose first element
is a **horizontal toolbar** — another `~pytanga.viz.StackView` with
...
```bash
uv run python py/examples/viz/scenes/toolbar.py
```

## Source

[`viz/scenes/toolbar.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/toolbar.py)
