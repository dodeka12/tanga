# Drive a VizGroup transform from a BasisN3 Motor
...
```bash
uv run python py/examples/viz/scenes/motor_group_transform.py
```

## Source

[`viz/scenes/motor_group_transform.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/motor_group_transform.py)
