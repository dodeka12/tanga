# Two named scenes, each shown in its own browser tab
...
```bash
uv run python py/examples/viz/scenes/multi_scene.py
```

## Source

[`viz/scenes/multi_scene.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/multi_scene.py)
