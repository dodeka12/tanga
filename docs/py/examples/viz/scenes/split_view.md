...
```bash
uv run python py/examples/viz/scenes/split_view.py
```

## Source

[`viz/scenes/split_view.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/split_view.py)
