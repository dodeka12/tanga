...
```bash
uv run python py/examples/viz/scenes/theme_switching.py
```

## Source

[`viz/scenes/theme_switching.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/theme_switching.py)
