# Demonstrate nested VizGroup hierarchies
...
```bash
uv run python py/examples/viz/scenes/nested_groups.py
```

## Source

[`viz/scenes/nested_groups.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/nested_groups.py)
