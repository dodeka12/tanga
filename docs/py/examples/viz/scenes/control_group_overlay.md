# Unified control groups: overlay-anchored + 3D-anchored
...
```bash
uv run python py/examples/viz/scenes/control_group_overlay.py
```

## Source

[`viz/scenes/control_group_overlay.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/control_group_overlay.py)
