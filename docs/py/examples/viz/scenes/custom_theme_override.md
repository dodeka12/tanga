...
```bash
uv run python py/examples/viz/scenes/custom_theme_override.py
```

## Source

[`viz/scenes/custom_theme_override.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/custom_theme_override.py)
