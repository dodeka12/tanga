...
**Keywords:** scenes · split view · panes · layout · multi-pane
...
```bash
uv run python py/examples/viz/scenes/multi_split.py
```

## Source

[`viz/scenes/multi_split.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/multi_split.py)
...
Run with:  uv run python py/examples/viz/scenes/multi_split.py
