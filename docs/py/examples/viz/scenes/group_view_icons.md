...
```bash
uv run python py/examples/viz/scenes/group_view_icons.py
```

## Source

[`viz/scenes/group_view_icons.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/scenes/group_view_icons.py)
