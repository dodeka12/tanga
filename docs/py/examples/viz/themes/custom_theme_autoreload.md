...
```bash
uv run python py/examples/viz/themes/custom_theme_autoreload.py
```

## Source

[`viz/themes/custom_theme_autoreload.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/themes/custom_theme_autoreload.py)
