# Demo: Drag TWO 3D points interactively with ActPoint
...
[`viz/interaction/act_point_two.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/interaction/act_point_two.py)
