...
Demonstrates the `~pytanga.viz.VisualizerApp` base class.
...
[`viz/interaction/two_spheres_interact.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/interaction/two_spheres_interact.py)
