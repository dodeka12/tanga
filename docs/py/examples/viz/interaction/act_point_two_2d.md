# Demo: Drag TWO 2D points interactively with ActPoint
...
[`viz/interaction/act_point_two_2d.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/interaction/act_point_two_2d.py)
