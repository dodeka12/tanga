# Demo: Drag a 3D point interactively with ActPoint
...
This demo uses `ActPoint` which registers its own interaction
...
[`viz/interaction/act_point.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/interaction/act_point.py)
