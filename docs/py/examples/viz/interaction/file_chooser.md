...
```bash
uv run python py/examples/viz/interaction/file_chooser.py
```

## Source

[`viz/interaction/file_chooser.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/interaction/file_chooser.py)
