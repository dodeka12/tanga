...
```bash
uv run python py/examples/viz/interaction/all_controls.py
```

## Source

[`viz/interaction/all_controls.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/interaction/all_controls.py)
