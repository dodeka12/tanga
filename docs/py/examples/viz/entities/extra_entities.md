# the Disk, PartialDisk, Box, Ellipsoid, Ellipse, and
...
- a solid `~pytanga.geometry.Disk` and a partial (pie-slice)
  `~pytanga.geometry.PartialDisk`,
- an axis-aligned `~pytanga.geometry.Box` and a
  `~pytanga.geometry.Ellipsoid`,
- a filled `~pytanga.geometry.Ellipse`,
- a `~pytanga.geometry.regular_polygon` (hexagon).
...
[`viz/entities/extra_entities.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/entities/extra_entities.py)
