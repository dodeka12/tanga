# Rotor, Translator, Motor, Dilator visualization
...
```bash
uv run python py/examples/viz/entities/operators.py
```

## Source

[`viz/entities/operators.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/entities/operators.py)
