# MV input from PGA3 and N3, OPNS vs IPNS
...
```bash
uv run python py/examples/viz/entities/multivector.py
```

## Source

[`viz/entities/multivector.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/entities/multivector.py)
