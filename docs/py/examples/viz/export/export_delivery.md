# Compare the three HTML delivery modes
...
```bash
uv run python py/examples/viz/export/export_delivery.py
```

## Source

[`viz/export/export_delivery.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/export/export_delivery.py)
