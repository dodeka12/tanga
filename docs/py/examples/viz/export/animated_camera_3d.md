# 3D animated HTML export with a moving camera
...
```bash
uv run python py/examples/viz/export/animated_camera_3d.py
```

## Source

[`viz/export/animated_camera_3d.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/export/animated_camera_3d.py)
