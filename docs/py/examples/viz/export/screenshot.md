# Programmatic PNG screenshot at custom resolution
...
```bash
uv run python py/examples/viz/export/screenshot.py
```

## Source

[`viz/export/screenshot.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/export/screenshot.py)
