# Presentation figure export with FigureStyle
...
```bash
uv run python py/examples/viz/export/figure.py
```

## Source

[`viz/export/figure.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/export/figure.py)
