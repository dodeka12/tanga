# Animated HTML export with JS playback engine
...
```bash
uv run python py/examples/viz/export/animated.py
```

## Source

[`viz/export/animated.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/export/animated.py)
