# Self-contained HTML and glTF export
...
```bash
uv run python py/examples/viz/export/html_export.py
```

## Source

[`viz/export/html_export.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/export/html_export.py)
