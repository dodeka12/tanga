# annotations in a CoordinateSystem's data frame
...
```bash
uv run python py/examples/viz/plotting/cs_annotations.py
```

## Source

[`viz/plotting/cs_annotations.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/plotting/cs_annotations.py)
...
"""cs_annotations.py — annotations in a CoordinateSystem's data frame.
