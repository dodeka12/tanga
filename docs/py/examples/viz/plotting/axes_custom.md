# Custom axes and grid as explicit scene objects
...
```bash
uv run python py/examples/viz/plotting/axes_custom.py
```

## Source

[`viz/plotting/axes_custom.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/plotting/axes_custom.py)
