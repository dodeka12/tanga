...
**Keywords:** scenes · menu · dropdown · sub-menu · bar · overlay · layout
...
```bash
uv run python py/examples/viz/menus/menu_demo.py
```

## Source

[`viz/menus/menu_demo.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/menus/menu_demo.py)
...
Run with:  uv run python py/examples/viz/menus/menu_demo.py
