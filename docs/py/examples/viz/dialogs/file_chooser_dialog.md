# A file-selection view, embedded and in a dialog box
...
```bash
uv run python py/examples/viz/dialogs/file_chooser_dialog.py
```

## Source

[`viz/dialogs/file_chooser_dialog.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/dialogs/file_chooser_dialog.py)
...
Run with:  uv run python py/examples/viz/dialogs/file_chooser_dialog.py
