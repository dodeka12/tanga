...
```bash
uv run python py/examples/viz/dialogs/dialog_demo.py
```

## Source

[`viz/dialogs/dialog_demo.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/dialogs/dialog_demo.py)
