# A custom theme with a full button/checkbox override
...
```bash
uv run python py/examples/viz/ui/themes/custom_theme_override.py
```

## Source

[`viz/ui/themes/custom_theme_override.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/themes/custom_theme_override.py)
...
Run with:  uv run python py/examples/viz/ui/themes/custom_theme_override.py
