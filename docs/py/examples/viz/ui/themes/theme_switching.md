# Switch the viewer theme at runtime without a reload
...
```bash
uv run python py/examples/viz/ui/themes/theme_switching.py
```

## Source

[`viz/ui/themes/theme_switching.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/themes/theme_switching.py)
...
Run with:  uv run python py/examples/viz/ui/themes/theme_switching.py
