# Load a custom theme and edit it live
...
```bash
uv run python py/examples/viz/ui/themes/custom_theme_autoreload.py
```

## Source

[`viz/ui/themes/custom_theme_autoreload.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/themes/custom_theme_autoreload.py)
...
Run with:  uv run python py/examples/viz/ui/themes/custom_theme_autoreload.py
