...
```bash
uv run python py/examples/viz/ui/dialogs/dialog_demo.py
```

## Source

[`viz/ui/dialogs/dialog_demo.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/dialogs/dialog_demo.py)
...
Run with:  uv run python py/examples/viz/ui/dialogs/dialog_demo.py
