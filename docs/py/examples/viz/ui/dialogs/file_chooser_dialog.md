...
```bash
uv run python py/examples/viz/ui/dialogs/file_chooser_dialog.py
```

## Source

[`viz/ui/dialogs/file_chooser_dialog.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/dialogs/file_chooser_dialog.py)
