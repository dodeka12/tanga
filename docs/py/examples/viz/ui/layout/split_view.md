# A single page showing multiple scenes in split panes
...
```bash
uv run python py/examples/viz/ui/layout/split_view.py
```

## Source

[`viz/ui/layout/split_view.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/layout/split_view.py)
...
"""split_view.py — A single page showing multiple scenes in split panes.
...
Run with:  uv run python py/examples/viz/ui/layout/split_view.py
