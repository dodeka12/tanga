...
```bash
uv run python py/examples/viz/ui/layout/layout_sizing.py
```

## Source

[`viz/ui/layout/layout_sizing.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/layout/layout_sizing.py)
...
Run with:  uv run python py/examples/viz/ui/layout/layout_sizing.py
