...
```bash
uv run python py/examples/viz/ui/controls/control_theming.py
```

## Source

[`viz/ui/controls/control_theming.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/controls/control_theming.py)
