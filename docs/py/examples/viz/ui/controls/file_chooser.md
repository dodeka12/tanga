# A file chooser with a backend-driven file browser
...
```bash
uv run python py/examples/viz/ui/controls/file_chooser.py
```

## Source

[`viz/ui/controls/file_chooser.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/controls/file_chooser.py)
