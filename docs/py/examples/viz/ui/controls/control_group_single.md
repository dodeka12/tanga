...
```bash
uv run python py/examples/viz/ui/controls/control_group_single.py
```

## Source

[`viz/ui/controls/control_group_single.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/controls/control_group_single.py)
