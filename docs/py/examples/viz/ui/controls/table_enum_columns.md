# A TableView with a column-fed enum and a backend-fed enum
...
```bash
uv run python py/examples/viz/ui/controls/table_enum_columns.py
```

## Source

[`viz/ui/controls/table_enum_columns.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/controls/table_enum_columns.py)
