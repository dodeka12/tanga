# Group view chrome: leading icon, icon-only, borderless fold
...
```bash
uv run python py/examples/viz/ui/controls/group_view_icons.py
```

## Source

[`viz/ui/controls/group_view_icons.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/controls/group_view_icons.py)
...
Run with:  uv run python py/examples/viz/ui/controls/group_view_icons.py
