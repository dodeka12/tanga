# Table auto-save: JSON load/save + CSV export
...
```bash
uv run python py/examples/viz/ui/controls/table_file.py
```

## Source

[`viz/ui/controls/table_file.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/controls/table_file.py)
