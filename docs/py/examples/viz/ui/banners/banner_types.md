# Demonstrates every banner/dialog kind
...
```bash
uv run python py/examples/viz/ui/banners/banner_types.py
```

## Source

[`viz/ui/banners/banner_types.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/banners/banner_types.py)
...
Run with:  uv run python py/examples/viz/ui/banners/banner_types.py
