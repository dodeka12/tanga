...
```bash
uv run python py/examples/viz/ui/banners/heavy_work.py
```

## Source

[`viz/ui/banners/heavy_work.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/banners/heavy_work.py)
...
Run with:  uv run python py/examples/viz/ui/banners/heavy_work.py
