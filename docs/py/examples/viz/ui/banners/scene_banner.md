# Banners scoped to a named scene via VizSceneHandle
...
```bash
uv run python py/examples/viz/ui/banners/scene_banner.py
```

## Source

[`viz/ui/banners/scene_banner.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/banners/scene_banner.py)
...
Run with:  uv run python py/examples/viz/ui/banners/scene_banner.py
