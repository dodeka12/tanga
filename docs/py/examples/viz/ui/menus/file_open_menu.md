...
```bash
uv run python py/examples/viz/ui/menus/file_open_menu.py
```

## Source

[`viz/ui/menus/file_open_menu.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/ui/menus/file_open_menu.py)
...
Run with:  uv run python py/examples/viz/ui/menus/file_open_menu.py
