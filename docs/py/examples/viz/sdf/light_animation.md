# Animate a directional light around a sphere
...
```bash
uv run python py/examples/viz/sdf/light_animation.py
```

## Source

[`viz/sdf/light_animation.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/sdf/light_animation.py)
...
"""light_animation.py — Animate a directional light around a sphere.
