# the unified SDF object model in the standard viewer
...
```bash
uv run python py/examples/viz/sdf/object_model.py
```

## Source

[`viz/sdf/object_model.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/sdf/object_model.py)
