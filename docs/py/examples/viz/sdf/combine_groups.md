# Combine multiple SdfGroups (nesting + merging)
...
```bash
uv run python py/examples/viz/sdf/combine_groups.py
```

## Source

[`viz/sdf/combine_groups.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/sdf/combine_groups.py)
