# SDF object groups with per-member CSG + independent animation

**Keywords:** SDF · group · CSG · animation

Builds an `SdfGroup` (two spheres with a cylinder cut out) rendered as
...
```bash
uv run python py/examples/viz/sdf/group.py
```

## Source

[`viz/sdf/group.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/sdf/group.py)
