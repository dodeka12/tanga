# isolate the SDF arrowhead (capped cone) placement
...
```bash
uv run python py/examples/viz/sdf/arrowhead.py
```

## Source

[`viz/sdf/arrowhead.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/sdf/arrowhead.py)
