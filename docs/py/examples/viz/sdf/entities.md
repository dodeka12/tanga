# First vertical slice for the SDF viewer
...
```bash
uv run python py/examples/viz/sdf/entities.py
```

## Source

[`viz/sdf/entities.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/sdf/entities.py)
