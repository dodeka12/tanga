# Mix standard meshes with SDF-styled objects
...
```bash
uv run python py/examples/viz/sdf/objects.py
```

## Source

[`viz/sdf/objects.py`](https://github.com/dodeka12/tanga/blob/main/py/examples/viz/sdf/objects.py)
