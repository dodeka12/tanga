...
| [Matrices & Coordinate Frames](coordinate-frames.md) | `Matrix`, `MatrixProvider`, `CoordinateFrame`/`OpenCVFrame` axis conventions |
...
| [Camera Calibration](camera-calibration.md) | `CameraCalibration`, OpenCV-style calibration + image/3D overlay |
