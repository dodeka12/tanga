...
//
// `NP` is the point-vector size, `NR` the full result space (all blades, so the
// scalar sits at slot 0 and the pseudoscalar at SLOT_PSEUDO). `snippet` is
// emitted once per distinct algebra by `eval.js` (Phase 8), deduped by identity.
