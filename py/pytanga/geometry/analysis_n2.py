...
def _classify_single_grade_versor(
    mv: MV, einf: MV, eo: MV
) -> Inversion | ReflectionLine | ReflectionPoint | HDirection:
...
def _classify_grade1_operator(op: MV, einf: MV, eo: MV) -> Inversion | ReflectionLine:
...
def _reflection_line_from_ipns_grade1(op: MV, einf: MV, eo: MV) -> ReflectionLine:
