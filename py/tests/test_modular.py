...
class TestIntegerAlgebra:
    ...
    def test_gp_integer_coefficients(self, alg):  # noqa: ANN001, ANN201
    ...
    def test_inv_requires_modulus(self, alg):  # noqa: ANN001, ANN201
        e1 = alg.multivector({"e1": 1})
        with pytest.raises((ValueError, TypeError)):
            alg.inv(e1)  # must fail: no modulus provided

    def test_inv_modular(self, alg):  # noqa: ANN001, ANN201
    ...
    def test_not_invertible_raises(self, alg):  # noqa: ANN001, ANN201
