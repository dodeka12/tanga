...
def alg_float():  # noqa: ANN201
    return Algebra(3, 0, "float64")


@pytest.fixture(scope="module")
def alg_int():  # noqa: ANN201
    return Algebra(3, 0, "int64")


@pytest.fixture(scope="module")
def vec_A_float(alg_float):  # noqa: ANN001, ANN201
...
@pytest.fixture(scope="module")
def vec_A_int(alg_int):  # noqa: ANN001, ANN201
...
@pytest.fixture(scope="module")
def mask_A_float(alg_float, vec_A_float):  # noqa: ANN001, ANN201
