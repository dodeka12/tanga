...
class TestMatrixConversion:
    def test_to_matrix_shape(self, alg_float, vec_A_float, mask_A_float):  # noqa: ANN001, ANN201
    ...
    def test_to_matrix_list(self, alg_float):  # noqa: ANN001, ANN201
    ...
    def test_round_trip(self, alg_float, vec_A_float, mask_A_float):  # noqa: ANN001, ANN201
        mat = to_matrix(vec_A_float, mask=mask_A_float)
        recovered = from_matrix(mat)
        assert recovered.to_dict() == vec_A_float.to_dict()

    def test_from_matrix_multi_column(self, alg_float):  # noqa: ANN001, ANN201
        mask = BladeMask(alg_float, [1, 2, 4])
    ...
    def test_to_matrix_scalar_input(self, alg_float):  # noqa: ANN001, ANN201
        scalar_mask = BladeMask(alg_float, grades=[0])
        mat = to_matrix(1.0, mask=scalar_mask)
        assert mat.data[0, 0] == pytest.approx(1.0)

    def test_to_matrix_string_input(self, alg_float):  # noqa: ANN001, ANN201
