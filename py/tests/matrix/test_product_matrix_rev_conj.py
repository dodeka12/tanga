...
class TestProductMatrixRevConj:
    def test_rev_shape_and_masks(self, alg_float):  # noqa: ANN001, ANN201
    ...
    def test_rev_diagonal_e3(self, alg_float):  # noqa: ANN001, ANN201
    ...
    def test_rev_subset_mask(self, alg_float):  # noqa: ANN001, ANN201
    ...
    def test_rev_scalar_only(self, alg_float):  # noqa: ANN001, ANN201
        mask = BladeMask(alg_float, grades=[0])
        M = product_matrix_rev(mask)
        assert M.data.shape == (1, 1, 1)
        assert M.data[0, 0, 0] == 1

    def test_conj_shape_and_masks(self, alg_float):  # noqa: ANN001, ANN201
        mask = BladeMask(alg_float, [0, 1, 2, 4])
    ...
    def test_conj_equals_rev_in_euclidean(self, alg_float):  # noqa: ANN001, ANN201
        mask = BladeMask.full(alg_float)
    ...
    def test_rev_applied_matches_algebra_rev(self, alg_float):  # noqa: ANN001, ANN201
    ...
    def test_conj_applied_matches_algebra_conj(self, alg_float):  # noqa: ANN001, ANN201
        a = alg_float({"e1": 2.0, "e2": -3.0, "e12": 1.0})
        mask = BladeMask(a)
        M = product_matrix_conj(mask)
        vec_a = to_matrix(a, mask=mask).data
    ...
    def test_rev_involution(self, alg_float):  # noqa: ANN001, ANN201
        mask = BladeMask.full(alg_float)
        M = product_matrix_rev(mask)
        M2d = M.data[0]
        id_approx = M2d @ M2d
    ...
    def test_conj_involution(self, alg_float):  # noqa: ANN001, ANN201
        mask = BladeMask.full(alg_float)
        M = product_matrix_conj(mask)
        M2d = M.data[0]
        id_approx = M2d @ M2d
    ...
    def test_rev_integer_algebra(self, alg_int):  # noqa: ANN001, ANN201
    ...
    def test_conj_integer_algebra(self, alg_int):  # noqa: ANN001, ANN201
        mask = BladeMask(alg_int, grades=[0, 1, 2, 3])
        M = product_matrix_conj(mask)
        assert M.data.dtype == np.int64
