...
class TestSolveFloat:
    def test_solve_inverse(self, alg_float):  # noqa: ANN001, ANN201
    ...
    def test_solve_general(self, alg_float):  # noqa: ANN001, ANN201
        a = alg_float({"e1": 1.0, "e2": -2.0, 0: 0.5})
    ...
    def test_solve_string_input(self, alg_float):  # noqa: ANN001, ANN201
        a = alg_float({"e1": 1.0, "e2": -2.0, 0: 0.5})
        x1 = solve(a, 1.0)
        x2 = solve(a, "1")
        assert x1.to_dict() == x2.to_dict()

    def test_solve_integer_algebra_raises(self, alg_int):  # noqa: ANN001, ANN201
        a = alg_int({"e1": 3})
        with pytest.raises(TypeError):
            solve(a, 1)

    def test_solve_lsq(self, alg_float):  # noqa: ANN001, ANN201
        a = alg_float({"e1": 1.0, "e2": -2.0, 0: 0.5})
        x = solve_lsq(a, 1.0)
        check = a * x
        check.prune()
    ...
    def test_solve_ip(self, alg_float):  # noqa: ANN001, ANN201
    ...
    def test_solve_non_square_gp_uses_lstsq(self, alg_float):  # noqa: ANN001, ANN201
