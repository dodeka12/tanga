...
def test_returns_short_hex(tmp_path):  # noqa: ANN001, ANN201
...
def test_structure_sensitive(tmp_path):  # noqa: ANN001, ANN201
...
def test_path_sensitive(tmp_path):  # noqa: ANN001, ANN201
