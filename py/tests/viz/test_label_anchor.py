...
class TestOtherAnchors:
    ...
    def test_circle_along_radius_and_angle(self):  # noqa: ANN201
    ...
    def test_sphere_default_center(self):  # noqa: ANN201
        assert compute_label_anchor(Sphere(Point(1, 2, 3), 2.0)) == (0.0, 0.0, 0.0)

    def test_sphere_pole(self):  # noqa: ANN201
        s = Sphere(Point(0, 0, 0), 3.0)
        assert compute_label_anchor(s, along=(1, 0, 0)) == (0.0, 0.0, 3.0)

    def test_sphere_along_radius_and_angles(self):  # noqa: ANN201
