...
class TestRaySerializer:
    def test_ray_styled_unsupported_kind_raises(self):  # noqa: ANN201
    ...
    def test_ray_styled_quadric_serializes(self):  # noqa: ANN201
...
class TestRayProxyCulling:
    def test_proxy_uses_backside(self):  # noqa: ANN201
    ...
    def test_two_sided_diffuse(self):  # noqa: ANN201
        code = (_RENDERS_DIR / "ray.js").read_text(encoding="utf-8")
    ...
    def test_intersect_call_is_range_clipped(self):  # noqa: ANN201
        code = (_RENDERS_DIR / "ray.js").read_text(encoding="utf-8")
