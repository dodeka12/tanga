...
class TestGradeProjList:
    def test_grade_int_still_works(self, alg):  # noqa: ANN001, ANN201
    ...
    def test_grade_list_multiple(self, alg):  # noqa: ANN001, ANN201
    ...
    def test_grade_list_empty(self, alg):  # noqa: ANN001, ANN201
        mv = alg.multivector({"s": 1.0, "e1": 2.0})
        result = mv.grade([])
        assert result.is_zero

    def test_algebra_grade_proj_list(self, alg):  # noqa: ANN001, ANN201
...
class TestProjectOnto:
    def test_project_onto_mv(self, alg):  # noqa: ANN001, ANN201
    ...
    def test_project_onto_mv_direction(self, alg):  # noqa: ANN001, ANN201
    ...
    def test_project_onto_blade_mask_exact(self, alg):  # noqa: ANN001, ANN201
    ...
    def test_project_onto_invalid_type(self, alg):  # noqa: ANN001, ANN201
