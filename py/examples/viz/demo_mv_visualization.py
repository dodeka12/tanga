...
viz.add(pga.point(5, 0, 0), color="#ff4444", style=PointStyle(size=0.15), opns=True, label="P (OPNS)")

# Same point in IPNS form (grade-1 vector)
viz.add(pga.point(5, 0, 0), color="#44ff44", style=PointStyle(size=0.10), opns=False, label="P (IPNS)")
...
viz.add(n3.sphere(-2, 0, 0, 1.5), style=SphereStyle(wireframe=True), opacity=0.35, label="Sphere")
