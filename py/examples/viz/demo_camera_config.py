...
viz1.add(Sphere(Point(0, 0, 0), radius=2.5), wireframe=True, opacity=0.3)
...
viz2.add(Sphere(Point(0, 0, 0), radius=2.5), wireframe=True, opacity=0.3)
viz2.run()
...
viz3.add(Sphere(Point(0, 0, 0), radius=2.5), wireframe=True, opacity=0.3)
viz3.run()
