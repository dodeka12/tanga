...
- [x] **4.1 — OPNS point-join → `PointSet`**
...
- [x] **4.2 — 2D two-conic intersection (thesis `ConicIntersect.tex` summary)**
...
- [x] **4.3 — `analyze_entity` wiring** — q2 grade 2 (IPNS) → two-conic
...
- [x] **4.5 — Validate** — `uv run pytest py/tests/geometry/test_conic_intersections.py -q`.
