...
- [x] **3.1 — `stack-view.js`: container knobs.**
...
- [x] **3.2 — `stack-view.js`: per-child flex.**
...
- [x] **3.3 — `group-view.js`: forward knobs.**
...
- [x] **3.4 — `control-view.js`: stop overriding flex/floors.**
...
- [x] **3.5 — `build.js`: pass knobs + make Python authoritative.**
...
- [x] **3.6 — `spacer-view.js`: fill leftover in flow.**
