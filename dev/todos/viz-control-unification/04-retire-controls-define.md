...
- [x] **4.1 — Backend removal (`visualizer.py`, `server.py`)**
...
- [x] **4.2 — Retire `ControlGroup` / `serialize_controls` (`_controls.py`)**
...
- [x] **4.3 — Frontend orphan-panel removal (`controls-panel.js`)**
