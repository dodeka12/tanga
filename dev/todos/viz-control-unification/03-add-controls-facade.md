...
- [ ] **3.1 — Add state (`visualizer.py` `__init__`)**
...
- [ ] **3.2 — `_get_or_create_orphan_group(scene_name)`**
...
- [ ] **3.3 — `_mount_orphan_control(scene_name, view)`**
...
- [ ] **3.5 — Route `_resolve_control` through `_control_views`**
...
- [ ] **3.6 — Consolidate value/field updates**
...
- [ ] **3.8 — `_add_scene_group` resolves ids via `_control_views`**
