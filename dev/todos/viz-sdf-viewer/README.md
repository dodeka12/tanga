...
update API, and browser reconnect/version parity); Phases 7–9 (algebra
embedding backend + shader eval + calibration) implemented; Phases 10–12
(finalize, CSG gate/smooth variants, opacity transfers) remain.
